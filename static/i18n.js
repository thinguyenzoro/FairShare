const translations = {
  en: {
    ...
    catGeneral: "📦 General",
    grpEnt: "Entertainment",
    catEntGames: "🎲 Games",
    catEntMovies: "🍿 Movies",
    catEntMusic: "🎵 Music",
    catEntSports: "⚽ Sports",
    catEntOther: "🎭 Other",
    grpFood: "Food and drink",
    catFoodDining: "🍽️ Dining out",
    catFoodGroceries: "🛒 Groceries",
    catFoodLiquor: "🍷 Liquor",
    catFoodOther: "🍔 Other",
    grpHome: "Home",
    catHomeSupplies: "🧻 Household supplies",
    catHomeMaintenance: "🛠️ Maintenance",
    catHomeRent: "🏡 Rent",
    catHomeOther: "🏠 Other",
    grpLife: "Life",
    ...
    catLifeGifts: "🎁 Gifts",
    catLifeMedical: "💊 Medical expenses",
    catLifeOther: "🌟 Other",
    grpTrans: "Transportation",
    catTransBicycle: "🚲 Bicycle",
    catTransBus: "🚌 Bus/train",
    catTransCar: "🚙 Car",
    catTransGas: "⛽ Gas/fuel",
    catTransHotel: "🏨 Hotel",
    catTransParking: "🅿️ Parking",
    catTransPlane: "✈️ Plane",
    catTransTaxi: "🚕 Taxi",
    catTransOther: "🚗 Other",
    grpUtil: "Utilities",
    catUtilCleaning: "🧹 Cleaning",
    catUtilElectricity: "⚡ Electricity",
    catUtilHeat: "🔥 Heat/gas",
    catUtilTrash: "🗑️ Trash",
    catUtilTv: "📺 TV/Phone/Internet",
    catUtilWater: "💧 Water",
    catUtilOther: "💡 Other",
    ...
    deleteRoomConfirmTitle: "Confirm Deletion",
    deleteRoomConfirm: "Are you sure you want to delete this room? It can be restored within 7 days.",
    roomScheduledDelete: "This room is scheduled for deletion.",
    daysLeftDelete: "Days left until permanent deletion:",
    restoreRoomBtn: "Restore Room",
    sectionExpenseList: "3. Expense list",
    sortOldest: "Oldest first",
    sortNewest: "Newest first",
    sortHighLow: "Amount: High to Low",
    sortLowHigh: "Amount: Low to High",
    filterAllCat: "All Categories",
    filterAllPayer: "All Payers",
    thCategory: "Category",
    thDesc: "Description",
    thAmount: "Amount",
    thPaidBy: "Paid by",
  ...
  vi: {
    ...
    catEntOther: "🎭 Khác",
    grpFood: "Ăn uống",
    catFoodDining: "🍽️ Ăn ngoài",
    catFoodGroceries: "🛒 Đi chợ/Siêu thị",
    catFoodLiquor: "🍷 Rượu bia",
    catFoodOther: "🍔 Khác",
    grpHome: "Nhà cửa",
    catHomeSupplies: "🧻 Đồ gia dụng",
    catHomeMaintenance: "🛠️ Sửa chữa",
    catHomeRent: "🏡 Tiền thuê nhà",
    catHomeOther: "🏠 Khác",
    grpLife: "Đời sống",
    ...
    catTransParking: "🅿️ Gửi xe",
    catTransPlane: "✈️ Máy bay",
    catTransTaxi: "🚕 Taxi",
    catTransOther: "🚗 Khác",
    grpUtil: "Tiện ích",
    catUtilCleaning: "🧹 Dọn dẹp",
    catUtilElectricity: "⚡ Tiền điện",
    catUtilHeat: "🔥 Tiền gas/lò sưởi",
    catUtilTrash: "🗑️ Rác thải",
    catUtilTv: "📺 TV/Điện thoại/Internet",
    ...
    cancelEditBtn: "Hủy",
    editBtn: "Sửa",
    deleteRoomBtn: "Xóa phòng",
    deleteRoomConfirmTitle: "Xác nhận xóa phòng",
    deleteRoomConfirm: "Bạn có chắc muốn xóa phòng này? Bạn có thể khôi phục nó trong vòng 7 ngày.",
    roomScheduledDelete: "Phòng này đã được lên lịch để xóa.",
    daysLeftDelete: "Số ngày còn lại trước khi xóa vĩnh viễn:",
    restoreRoomBtn: "Khôi phục phòng",
    sectionExpenseList: "3. Danh sách chi tiêu",
    sortOldest: "Cũ nhất trước",
    sortNewest: "Mới nhất trước",
    sortHighLow: "Số tiền: Cao - Thấp",
    sortLowHigh: "Số tiền: Thấp - Cao",
    filterAllCat: "Tất cả danh mục",
    filterAllPayer: "Tất cả người trả",
    thCategory: "Danh mục",
    thDesc: "Mô tả",
    thAmount: "Số tiền",
    thPaidBy: "Trả bởi",
